...
const obj = {
	txt_mediapackage_id: $('#pnl_edit-txt_mediapackage_id'),
	txt_mediapackage_descr: $('#pnl_edit-txt_mediapackage_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_mediapackage_id,
		autoid: true,
		logview: 'mst_mediapackage',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editslotgrid'].handler.createnew(data, options)
...
function form_idsetup(options) {
	var objid = obj.txt_mediapackage_id
