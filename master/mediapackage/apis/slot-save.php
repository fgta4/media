...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_mediapackageslot';
		$primarykey = 'mediapackageslot_id';
		...
		try {
			...
			try {
				...
				$header_table = 'mst_mediapackage';
				$header_primarykey = 'mediapackage_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'mediapackageslot_id', 'mediaadslot_id', 'mediapackage_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
