...
const obj = {
	...
	txt_mediaordertype_name: $('#pnl_edit-txt_mediaordertype_name'),
	txt_mediaordertype_descr: $('#pnl_edit-txt_mediaordertype_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_mediaordertype_id,
		autoid: false,
		logview: 'mst_mediaordertype',
...
function form_idsetup(options) {
	var objid = obj.txt_mediaordertype_id
