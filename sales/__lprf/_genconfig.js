...
module.exports = {
	...
	persistent: {
		...
		'trn_medialogproofupload' : {
			...
			data: {
				...
				mediaadslot_code: { text: 'SlotCode', type: dbtype.varchar(255) },

				actual_timestart: { text: 'ActualTimeStart', type: dbtype.varchar(90), null: false, uppercase: true, options: { required: true, invalidMessage: 'Waktu Actual Mulai harus diisi' } },
				actual_timeend: { text: 'ActualTimeEnd', type: dbtype.varchar(90), null: false, uppercase: true, options: { required: true, invalidMessage: 'Waktu Actual Selesai harus diisi' } },
				actual_duration: { text: 'ActualDuration', type: dbtype.decimal(6,2), null: false, uppercase: true, options: { required: true, invalidMessage: 'Durasi harus diisi' } },

				spot_id : { text: 'SpotId', type: dbtype.decimal(6,2), null: false, uppercase: true, options: { required: true, invalidMessage: 'Spot id harus diisi' } },

				mediaorder_ref: { text: 'MeidaOrderRef', type: dbtype.varchar(30) },
				mediaorder_reftype: { text: 'TypeMediaOrder', type: dbtype.varchar(30) },
				mediaorder_descr: { text: 'MediaOrderDescr', type: dbtype.varchar(255) },
				mediaorder_id: { text: 'MediaOrderId', type: dbtype.varchar(30), suppresslist: true, hidden: true, unset:true, options: {disabled: true} },

				agency_code: { text: 'AgencyCode', type: dbtype.varchar(30) },
				...
				advertiser_code: { text: 'AdvertiserCode', type: dbtype.varchar(30) },
				...
				brand_code: { text: 'BrandCode', type: dbtype.varchar(30) },
				...
				programme_code: { text: 'ProgrammeCode', type: dbtype.varchar(30) },
				...
				episode_code: { text: 'EpisodeCode', type: dbtype.varchar(30) },
	...
	schema: {
		...
		detils: {
			...
			'upload': {title: 'Item', table: 'trn_medialogproofupload', form: true, headerview: 'medialogproof_date' },
		}
	}
}
