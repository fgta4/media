...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->mediaorderitem_id = strtoupper($obj->mediaorderitem_id);
			$obj->mediaorderitem_descr = strtoupper($obj->mediaorderitem_descr);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'mediaorderitem_id', 'mediaorderitem_descr', 'mediaadslot_id', 'itemclass_id', 'mediaorderitem_price', 'mediaorder_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'mediaadslot_descr' => \FGTA4\utils\SqlUtility::Lookup($data->mediaadslot_id, $this->db, 'mst_mediaadslot', 'mediaadslot_id', 'mediaadslot_descr'),
