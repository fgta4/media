...
class DataOpen extends WebAPI {
	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('trn_mediaorderitem', [
				'mediaorderitem_id', 'mediaorderitem_descr', 'mediaadslot_id', 'itemclass_id', 'mediaorderitem_price', 'mediaorder_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
