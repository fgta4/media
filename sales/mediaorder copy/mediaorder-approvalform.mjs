...
const obj = {
	txt_mediaorderappr_id: $('#pnl_editapprovalform-txt_mediaorderappr_id'),
	chk_mediaorderappr_isapproved: $('#pnl_editapprovalform-chk_mediaorderappr_isapproved'),
	txt_mediaorderappr_by: $('#pnl_editapprovalform-txt_mediaorderappr_by'),
	txt_mediaorderappr_date: $('#pnl_editapprovalform-txt_mediaorderappr_date'),
	txt_mediaorder_version: $('#pnl_editapprovalform-txt_mediaorder_version'),
	chk_mediaorderappr_isdeclined: $('#pnl_editapprovalform-chk_mediaorderappr_isdeclined'),
	txt_mediaorderappr_declinedby: $('#pnl_editapprovalform-txt_mediaorderappr_declinedby'),
	txt_mediaorderappr_declineddate: $('#pnl_editapprovalform-txt_mediaorderappr_declineddate'),
	txt_mediaorderappr_notes: $('#pnl_editapprovalform-txt_mediaorderappr_notes'),
	txt_mediaorder_id: $('#pnl_editapprovalform-txt_mediaorder_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_mediaorderappr_id,
		autoid: true,
		logview: 'trn_mediaorderappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.mediaorder_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_mediaorderappr_id
