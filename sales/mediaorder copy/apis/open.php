	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('trn_mediaorder A', [
				'mediaorder_id', 'orderintype_id', 'mediaorder_date', 'mediaorder_descr', 'mediaorder_ref', 'ae_empl_id', 'agency_partner_id', 'advertiser_partner_id', 'mediaorder_traffic', 'mediaorder_status', 'mediaorder_direct', 'mediaorder_bundling', 'brand_id', 'dept_id', 'trxmodel_id', 'orderin_totalitem', 'orderin_totalqty', 'orderin_salesgross', 'orderin_discount', 'orderin_subtotal', 'orderin_pph', 'orderin_nett', 'orderin_ppn', 'orderin_total', 'orderin_totaladdcost', 'orderin_payment', 'doc_id', 'mediaorder_version', 'mediaorder_iscommit', 'mediaorder_commitby', 'mediaorder_commitdate', 'mediaorder_isapprovalprogress', 'mediaorder_isapproved', 'mediaorder_approveby', 'mediaorder_approvedate', 'mediaorder_isdeclined', 'mediaorder_declineby', 'mediaorder_declinedate', 'mediaorder_notes', 'mediaorder_isclose', 'mediaorder_closeby', 'mediaorder_closedate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
