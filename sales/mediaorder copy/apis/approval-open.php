...
/**
 * media/sales/mediaorder/apis/approval-open.php
 *
 * ==========
 * Detil-Open
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel approval} mediaorder (trn_mediaorder)
 *
...
$API = new class extends mediaorderBase {
	...
	public function execute($options) {
		$tablename = 'trn_mediaorderappr';
		$primarykey = 'mediaorderappr_id';
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"mediaorderappr_id" => " mediaorderappr_id = :mediaorderappr_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('trn_mediaorderappr A', [
