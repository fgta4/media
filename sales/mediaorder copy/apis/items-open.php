	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('trn_mediaorderitem A', [
				'mediaorderitem_id', 'itemclass_id', 'mediaorderitem_spot', 'mediaorderitem_descr', 'mediaorderitem_validr', 'projbudget_id', 'projbudgettask_id', 'project_id', 'projecttask_id', 'mediaorder_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
