	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"medialogproof_id" => " medialogproof_id = :medialogproof_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('trn_medialogproof A', [
				'medialogproof_id', 'medialogproof_date', 'medialogproof_iscommit', 'medialogproof_isgenerate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
