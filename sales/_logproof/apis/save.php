...
$API = new class extends logproofBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->medialogproof_date = (\DateTime::createFromFormat('d/m/Y',$obj->medialogproof_date))->format('Y-m-d');
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'medialogproof_id', 'medialogproof_date', 'medialogproof_iscommit', 'medialogproof_isgenerate', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
