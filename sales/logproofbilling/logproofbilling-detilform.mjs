...
const obj = {
	txt_medialogproofbillingdet_id: $('#pnl_editdetilform-txt_medialogproofbillingdet_id'),
	txt_mediaorder_id: $('#pnl_editdetilform-txt_mediaorder_id'),
	txt_billout_id: $('#pnl_editdetilform-txt_billout_id'),
	dt_medialogproofbilling_gendate: $('#pnl_editdetilform-dt_medialogproofbilling_gendate'),
	txt_medialogproofbilling_id: $('#pnl_editdetilform-txt_medialogproofbilling_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_medialogproofbillingdet_id,
		autoid: true,
		logview: 'trn_medialogproofbillingdet',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.medialogproofbilling_date)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.medialogproofbilling_id= hdata.medialogproofbilling_id
		data.detil_value = 0

		data.medialogproofbilling_gendate = global.now()
...
function form_idsetup(options) {
	var objid = obj.txt_medialogproofbillingdet_id
